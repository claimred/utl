...
call emcc src/main.cpp ../utl-core/src/camera.cpp ^
...
-I ../utl-core/src -s USE_SDL_IMAGE=2 -s SDL2_IMAGE_FORMATS="[""png""]" -s USE_SDL=2 -o utl.html -O2 --memory-init-file 0 -W --preload-file res -s ALLOW_MEMORY_GROWTH=1

move utl.data utl\em\
move utl.js utl\em\
move utl.html utl\em\